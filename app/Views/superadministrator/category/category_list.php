                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($Page->parent . '/index?sortcolumn=' . base64_encode('category_name') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC')); ?>" class="stringetched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($Page->parent . '/index?sortcolumn=' . base64_encode('category_detail') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC')); ?>" class="stringetched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                                    <?php if ($sortcolumn == "category_detail") : ?>
                                                        <i class="fas fa-sort-alpha-<?php echo ($sortorder == 'DESC' ? 'down' : 'up'); ?>"></i>&nbsp;
                                                    <?php endif ?>
                                                    Category_detail
                                                </a>
