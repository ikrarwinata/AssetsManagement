                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($Page->parent . '/index?sortcolumn=' . base64_encode('master_name') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC')); ?>" class="stringetched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                                    <?php if ($sortcolumn == "master_name") : ?>
                                            ...
                                            <th style="transform: rotate(0);">
                                                <a href="<?php echo base_url($Page->parent . '/index?sortcolumn=' . base64_encode('category_id') . '&sortorder=' . ($sortorder == 'ASC' ? 'DESC' : 'ASC')); ?>" class="stringetched-link text-decoration-none" style="text-decoration: none;color: #243245;">
                                                    <?php if ($sortcolumn == "category_id") : ?>
                                                        <i class="fas fa-sort-alpha-<?php echo ($sortorder == 'DESC' ? 'down' : 'up'); ?>"></i>&nbsp;
                                                    <?php endif ?>
                                                    Category_id
                                                </a>
