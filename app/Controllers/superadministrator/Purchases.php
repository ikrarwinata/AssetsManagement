...
class Purchases extends BaseController
{
    ...
    {
        $this->model = new Purchases_model(); //Set Default Models Of this Controller
    ...
    {
        return (object) [
            'parent' => 'superadministrator/Purchases',
            'header' => (session("level") == NULL ? NULL : session("level") . " :: ") . 'Purchases', 
            'title' => 'Purchases',
            'subtitle' => [
                'Purchases' => 'superadministrator/Purchases/index'
            ],
            'url' => 'superadministrator/Purchases/index',
            'stylesheets' => [],
            'scripts' => [],
            'locale' => 'id',
    ...
    public function index()
    {
        ...
        $this->PageData->url = "superadministrator/Purchases/index";
        $this->PageData->subtitle = [
            $this->PageData->title => 'superadministrator/Purchases/index'
        ];
        ...
        return view('superadministrator/purchases/purchases_list', $data);
        //endindex
    }
    ...
    public function read($id=NULL)
    {
        ...
        $this->PageData->title = "Purchases Detail";
        $this->PageData->header .= ' :: Detail';
        $this->PageData->subtitle = [
            'Purchases' => 'superadministrator/Purchases/index',
            'Detail' => 'superadministrator/Purchases/read/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "superadministrator/Purchases/read/" . urlencode(base64_encode($id));
        ...
        return view('superadministrator/purchases/purchases_read', $data);
    }
    ...
    public function create()
    {
        ...
        $this->PageData->title = "Create Purchases";
        $this->PageData->subtitle = [
            'Purchases' => 'superadministrator/Purchases/index',
            lang("Default.CreateItem", [], $this->PageData->locale) => 'superadministrator/Purchases/create',
        ];
        $this->PageData->url = "superadministrator/Purchases/create";
        $this->PageData->scripts = ['assets/js/ajax.js'];
        ...
        return view('superadministrator/purchases/purchases_form', $data);
    }
    ...
    public function update($id=NULL)
    {
        ...
        $this->PageData->title = "Update Purchases";
        $this->PageData->subtitle = [
            'Purchases' => 'superadministrator/Purchases/index',
            lang("Default.UpdateItem", [], $this->PageData->locale) => 'superadministrator/Purchases/update/' . urlencode(base64_encode($id)),
        ];
        $this->PageData->url = "superadministrator/Purchases/update/" . urlencode(base64_encode($id));
        ...
        $data = [
            'data' => (object) [
                ...
                'sold' => set_value('sold', $dataFind->sold),
            ],
    ...
    public function toExcel(){
        ...
        $this->response->setHeader('Content-Disposition', 'attachment;filename="Purchases ' . date("Y") . '.xlsx"');
        // If you're serving to IE 9, then the following may be needed
        $cacheOptions = [
            'max-age'  => 1,
            's-maxage' => 900,
            'etag'     => 'excel_Purchases'
        ];
    ...
    public function toWord()
    {
        ...
        $this->response->setHeader('Content-Disposition', 'attachment;filename="Purchases ' . date("Y") . '.doc"');
        ...
        $this->PageData->subtitle = ["Purchases", "Word  Document File"];
        ...
        return view('superadministrator/purchases/purchases_doc', $data);
    }
    ...
    public function toPdf(){
        ...
        $this->PageData->subtitle = ["Purchases", "PDF File"];
        ...
        $temp = $view->setData($data)->render('superadministrator/purchases/purchases_pdf');
        ...
        $mdpfFilename = "Purchases " . date("d_m_Y") . ".pdf";
        $mpdf->WriteHTML($temp);
    ...
    public function printAll(){
        ...
        $this->PageData->title = "Purchases Data";
        $this->PageData->subtitle = ["Purchases", "Print All"];
        $this->PageData->url = "superadministrator/Purchases/printAll/";
        ...
        return view('superadministrator/purchases/purchases_print', $data);
    }
